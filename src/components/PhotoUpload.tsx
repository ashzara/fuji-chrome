...
export default function PhotoUpload({ onFiles, disabled }: Props) {
  ...
  return (
    ...
    >
      ...
      <div className="text-center">
        <p className="text-[#e8e8e8] font-medium">Drop photos here</p>
        <p className="text-[#666] text-sm mt-1">or click to browse · select one or many · JPG, PNG, WEBP</p>
      </div>
